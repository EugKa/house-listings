...
export const UserProfile = ({user, viewerIsUser, viewer, setViewer, handleUserRefetch}:Props) => {
    ...
    const additionalDetails = user.hasWallet ? (
        <Fragment>
            <Paragraph>
                <Tag color="green">Stripe Register</Tag>
            </Paragraph>
            <Paragraph>
                Income Earned: {" "}
        ...
        <Fragment>
            <Paragraph>
                Interestad in becoming a TinyHouse host? Register with your Stripe account!
            </Paragraph>
            <Button 
                type="primary" 
                className="user-profile__details-cta"
            ...
            <Paragraph type="secondary">
                ...
                >
                    Stripe
                </a> to help transfer your earnings in a secure and truster manner.
            </Paragraph>
        </Fragment>
    )
